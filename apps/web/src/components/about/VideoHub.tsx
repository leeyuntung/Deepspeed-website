                    ...
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
                        ...
                        <div className="group cursor-pointer">
                            <div className="aspect-video bg-zinc-900 rounded-lg overflow-hidden mb-3 relative">
                                <Image
                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuC1rdUU569jsR2-_6GCyxAjIxyygv7TJuGUSsFIRcdmo5QJLQlfclk261MhHO2lyElvyJYhi9DALaMkiwLxwNFKBQcAsqtcO7wTbYcSMd5fjdVtr4cAabWIUuQhERu60dHHBBhqgdwaVBgFJ917qWn0rCqrNpAewJPDJW1pi1MKEdL-JyAczSyFowfg4knST_AIcDI1Gh06xSDA70XvpTi3KjXlWYcQ7fd-ms_HqrwN7RVI_stlVZ4B0maOXXB0jodBgViH0fZz86U"
                                    alt="Telemetry"
                                    fill
                        ...
                        <div className="group cursor-pointer">
                            <div className="aspect-video bg-zinc-900 rounded-lg overflow-hidden mb-3 relative">
                                <Image
                                    src="https://lh3.googleusercontent.com/aida-public/AB6AXuDFyjFKudjL2gsHC7R_SP9jRPfhFniGdWVLNaZeJrfKy4Mj7p6wKRQ_HKph1BoL_zjnMn_3Oe2iWZSLCL1E4G6XswmBC0jhZTyEpt0DruBJ913i7a9tbl2dVa-svisu6LVXdXsVBCyiDkX53zV9AxXu_akYXJynhA0OeugCsugng6tfUCmHD9LNb9eTsoWDr9CkPP6FPwbVcP4qR4sdMXrvHwKrfYtdhzy_lN4_HhXJtjSINJNkMFOm1bf50aRP0LmrqGwOc2iidMA"
                                    alt="Neural Net"
                                    fill
                                    className="object-cover opacity-50 group-hover:opacity-80 transition-opacity"
                                />
